...
public class Cross_PlatForm {
	...
	public static void CrossPlatForm(WebDriver driver) throws InterruptedException {
		...
		{
			Assert.fail("\n Global home Page could not be opened");
			driver.close();
		}
		else
		{
			...
			{
				Assert.fail("\n City Overview page url is wrong or not opening");			
			}
			...
			{
				Assert.fail("\n Change locality page is not opening basis url is wrong, searchbox not found and heading is wrong");
				driver.quit();
			}
			...
			{
				Assert.fail("\n logo click is not opening city home page");
				driver.quit();
			}
			...
			{
				Assert.fail("Builder listing page is not opening");
				driver.quit();
			}
			...
			{
				Assert.fail("Builder page is not opening");
				driver.quit();
			}
			...
			{
				Assert.fail("City Builder page is not opening");
				driver.quit();
			}
			...
			{
				Assert.fail("All city page is not opening");
				driver.quit();
			}
